...
class Server
{
  ...
  private:
	...
	typedef ft::shared_ptr<ErrorResponseHandler> _ErrorResponseHandlerPtr;
	...
	std::map<int, std::queue<_ErrorResponseHandlerPtr> > _error_handlers;
	...
	void iterateErrorHandlers(void);
